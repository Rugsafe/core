...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `signature` | [bytes](#bytes) |  | Specific fields for Schnorr claims, e.g., signature, message, etc. |
| `message` | [string](#string) |  | Optional message that was signed, if applicable |
